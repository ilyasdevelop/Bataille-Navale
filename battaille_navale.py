...
#affichage de la moyenne de l'ensemble des scores 


# Calcul de la moyenne des scores pour chaque personnage
moyenne_scores = {eleve: total_scores[eleve] / 10 for eleve in tableau_eleves}

# Affichage de la moyenne des scores pour chaque personnage
for personnage, moyenne_score in moyenne_scores.items():
    print(f"Moyenne de {personnage} : {moyenne_score}")
